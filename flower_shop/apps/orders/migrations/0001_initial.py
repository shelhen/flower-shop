    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(1, '待付款'), (2, '待发货'), (3, '待收货'), (4, '待退款'), (5, '待评价'), (6, '已完成'), (7, '已退款')], default=1, verbose_name='订单状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.goods', verbose_name='订单商品')),
            ],
            options={
                'verbose_name': '订单商品',
